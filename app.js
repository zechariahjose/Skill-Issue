...
const PET_CLINIC_FULL_SCHEMA_SQL = `CREATE TABLE Owners (owner_id INT AUTO_INCREMENT PRIMARY KEY,first_name VARCHAR(50) NOT NULL,last_name VARCHAR(50) NOT NULL,phone VARCHAR(20) NOT NULL,email VARCHAR(100) UNIQUE,created_at TIMESTAMP NOT NULL);
CREATE TABLE Pets (pet_id INT AUTO_INCREMENT PRIMARY KEY,owner_id INT NOT NULL,name VARCHAR(50) NOT NULL,species VARCHAR(30) NOT NULL, -- e.g., Dog, Cat, Reptilebreed VARCHAR(50),birth_date DATE,allergies_or_notes TEXT,FOREIGN KEY (owner_id) REFERENCES Owners(owner_id) ON DELETE CASCADE);
CREATE TABLE Staff (staff_id INT AUTO_INCREMENT PRIMARY KEY,first_name VARCHAR(50) NOT NULL,last_name VARCHAR(50) NOT NULL,role VARCHAR(50) NOT NULL, -- e.g., Veterinarian, Groomer, Physiotherapist, Camp Leaderphone VARCHAR(20),is_active BOOLEAN DEFAULT TRUE);
CREATE TABLE Services (service_id INT AUTO_INCREMENT PRIMARY KEY,service_name VARCHAR(100) NOT NULL,category ENUM('Medical', 'Beauty', 'Wellness', 'Recreation') NOT NULL,price DECIMAL(10, 2) NOT NULL,duration_minutes INT NOT NULL);
CREATE TABLE Appointments (appointment_id INT AUTO_INCREMENT PRIMARY KEY,pet_id INT NOT NULL,staff_id INT NOT NULL,service_id INT NOT NULL,appointment_timestamp DATETIME NOT NULL,status ENUM('Scheduled', 'Completed', 'Canceled', 'No-Show') DEFAULT 'Scheduled',total_cost DECIMAL(10, 2) NOT NULL,created_at TIMESTAMP not null,FOREIGN KEY (pet_id) REFERENCES Pets(pet_id) ON DELETE CASCADE,FOREIGN KEY (staff_id) REFERENCES Staff(staff_id),FOREIGN KEY (service_id) REFERENCES Services(service_id));
CREATE TABLE Medical_Details (medical_id INT AUTO_INCREMENT PRIMARY KEY,appointment_id INT UNIQUE NOT NULL,weight_kg DECIMAL(5, 2),temperature_c DECIMAL(4, 1),symptoms_reported TEXT,diagnosis TEXT,treatment_plan TEXT,follow_up_required BOOLEAN DEFAULT FALSE,FOREIGN KEY (appointment_id) REFERENCES Appointments(appointment_id) ON DELETE CASCADE);
CREATE TABLE Beauty_Details (beauty_id INT AUTO_INCREMENT PRIMARY KEY,appointment_id INT UNIQUE NOT NULL,haircut_style VARCHAR(100), -- e.g., Teddy Bear Cut, Lion Cut, Summer Shaveshampoo_type VARCHAR(50),  -- e.g., Hypoallergenic, Oatmeal, Flea Treatmentnail_trimming BOOLEAN DEFAULT TRUE,ear_cleaning BOOLEAN DEFAULT TRUE,grooming_notes TEXT,       -- e.g., "Anxious around high-velocity dryers"FOREIGN KEY (appointment_id) REFERENCES Appointments(appointment_id) ON DELETE CASCADE);
CREATE TABLE Wellness_Details (wellness_id INT AUTO_INCREMENT PRIMARY KEY,appointment_id INT UNIQUE NOT NULL,therapy_type VARCHAR(50),  -- e.g., Hydrotherapy, Acupuncture, Laser Therapy, Behavior Modsession_goals TEXT,dietary_recommendations TEXT,pet_response_notes TEXT,   -- Notes on mobility improvements or calming successFOREIGN KEY (appointment_id) REFERENCES Appointments(appointment_id) ON DELETE CASCADE);
CREATE TABLE Recreation_Details (recreation_id INT AUTO_INCREMENT PRIMARY KEY,appointment_id INT UNIQUE NOT NULL,activity_type VARCHAR(50), -- e.g., Agility Course, Group Play, Swimming, Daycaresocialization_score INT CHECK (socialization_score BETWEEN 1 AND 5), -- Compatibility ratingenergy_level_observed ENUM('Low', 'Moderate', 'High', 'Hyperactive'),incident_report TEXT,      -- Logs any minor scuffles, injuries, or behavioral red flagsFOREIGN KEY (appointment_id) REFERENCES Appointments(appointment_id) ON DELETE CASCADE);
-- 1. Populate Owners (10 Rows)
INSERT INTO Owners (owner_id, first_name, last_name, phone, email, created_at) VALUES(1, 'Eleanor', 'Vance', '555-0192', 'eleanor.v@mail.com', '2026-01-10 08:30:00'),(2, 'Marcus', 'Briggs', '555-0144', 'marcus.b@mail.com', '2026-01-12 14:15:00'),(3, 'Sonia', 'Patel', '555-0178', 'spatel@petnet.org', '2026-01-15 09:00:00'),(4, 'David', 'Kim', '555-0121', 'kim.david@global.com', '2026-02-01 11:11:00'),(5, 'Chloe', 'Garnett', '555-0165', 'chloe.g@outlook.com', '2026-02-14 16:45:00'),(6, 'Julian', 'Alvarez', '555-0231', 'jalvarez@vertex.com', '2026-02-20 10:20:00'),(7, 'Miriam', 'Vogel', '555-0289', 'mvogel@biolabs.org', '2026-03-02 09:15:00'),(8, 'Terrence', 'Howard', '555-0342', 'thoward@cloudnet.io', '2026-03-11 14:40:00'),(9, 'Fiona', 'Gallagher', '555-0411', 'fiona.g@southside.net', '2026-03-15 11:05:00'),(10, 'Raymond', 'Holt', '555-0500', 'rholt@nyps.gov', '2026-03-22 08:00:00');
-- 2. Populate Pets (10 Rows)
INSERT INTO Pets (pet_id, owner_id, name, species, breed, birth_date, allergies_or_notes) VALUES(101, 1, 'Barnaby', 'Dog', 'Golden Retriever', '2021-04-12', 'Allergies to chicken protein. Sensitive skin.'),(102, 1, 'Mittens', 'Cat', 'Siamese', '2023-08-19', 'Extremely anxious around loud noises.'),(103, 2, 'Rex', 'Dog', 'German Shepherd', '2019-11-02', 'Slight hip dysplasia in rear legs.'),(104, 3, 'Ziggy', 'Reptile', 'Bearded Dragon', '2022-01-05', 'Requires careful temperature regulation.'),(105, 4, 'Bella', 'Dog', 'French Bulldog', '2024-05-30', 'Brachycephalic; prone to overheating.'),(106, 5, 'Luna', 'Cat', 'Maine Coon', '2020-07-22', 'No known allergies. Long coat requires daily grooming.'),(107, 6, 'Buster', 'Dog', 'Boxer', '2022-10-14', 'Highly energetic, needs high physical activity.'),(108, 7, 'Pip', 'Bird', 'Parakeet', '2024-01-10', 'Prone to stress plucking if left alone.'),(109, 8, 'Shadow', 'Dog', 'Labrador', '2018-05-05', 'Arthritic changes in front left wrist elbow.'),(110, 9, 'Whiskers', 'Cat', 'Persian', '2021-12-25', 'Requires daily facial fold cleaning clean ups.');
-- 3. Populate Staff (10 Rows)
INSERT INTO Staff (staff_id, first_name, last_name, role, phone, is_active) VALUES(10, 'Dr. Aris', 'Thorne', 'Veterinarian', '555-8801', TRUE),(20, 'Melissa', 'Alvarado', 'Groomer', '555-8802', TRUE),(30, 'Jonathan', 'Rye', 'Physiotherapist', '555-8803', TRUE),(40, 'Sarah', 'Jenkins', 'Camp Leader', '555-8804', TRUE),(50, 'Dr. Emily', 'Sloane', 'Veterinarian', '555-8805', FALSE),(60, 'Kofi', 'Anan', 'Camp Leader', '555-8806', TRUE),(70, 'Bianca', 'Castillo', 'Groomer', '555-8807', TRUE),(80, 'Dr. Henry', 'Wu', 'Veterinarian', '555-8808', TRUE),(90, 'Chloe', 'Zhao', 'Physiotherapist', '555-8809', TRUE),(100, 'Nils', 'Lofgren', 'Groomer', '555-8810', FALSE);
-- 4. Populate Services (10 Rows)
INSERT INTO Services (service_id, service_name, category, price, duration_minutes) VALUES(1, 'Comprehensive Clinical Exam', 'Medical', 85.00, 30),(2, 'Core Vaccine Suite', 'Medical', 145.00, 15),(3, 'Full Grooming & Styling Package', 'Beauty', 175.00, 90),(4, 'Nail Trim & Ear Flushing combo', 'Beauty', 125.00, 20),(5, 'Hydrotherapy Session', 'Wellness', 110.00, 45),(6, 'Behavioral Correction Therapy', 'Wellness', 95.00, 60),(7, 'Full-Day Socialization Camp', 'Recreation', 40.00, 480),(8, 'Agility & Fitness Play Session', 'Recreation', 35.00, 60),(9, 'Acupuncture & Pain Management', 'Wellness', 120.00, 40),(10, 'Weekend Luxury Boarding Stays', 'Recreation', 150.00, 1440);
-- 5. Populate Appointments (10 Rows)
INSERT INTO Appointments (appointment_id, pet_id, staff_id, service_id, appointment_timestamp, status, total_cost, created_at) VALUES(1001, 101, 10, 1, '2026-06-20 09:00:00', 'Completed', 85.00, '2026-06-15 10:00:00'),(1002, 101, 20, 3, '2026-06-20 10:30:00', 'Completed', 75.00, '2026-06-15 10:05:00'),(1003, 103, 30, 5, '2026-06-21 13:00:00', 'Completed', 110.00, '2026-06-16 11:20:00'),(1004, 105, 40, 7, '2026-06-22 08:00:00', 'Completed', 40.00, '2026-06-18 14:00:00'),(1005, 102, 20, 3, '2026-06-24 11:00:00', 'Canceled', 75.00, '2026-06-22 09:30:00'),(1006, 104, 10, 1, '2026-06-25 15:30:00', 'Completed', 85.00, '2026-06-23 16:10:00'),(1007, 106, 20, 3, '2026-06-26 14:00:00', 'Scheduled', 75.00, '2026-06-24 12:00:00'),(1008, 107, 60, 8, '2026-06-27 10:00:00', 'Completed', 35.00, '2026-06-25 09:00:00'),(1009, 109, 90, 9, '2026-06-28 11:30:00', 'Completed', 120.00, '2026-06-25 14:15:00'),(1010, 110, 70, 3, '2026-06-29 13:00:00', 'Scheduled', 75.00, '2026-06-26 10:45:00');
-- 6. Populate Medical_Details (10 Rows)
INSERT INTO Medical_Details (medical_id, appointment_id, weight_kg, temperature_c, symptoms_reported, diagnosis, treatment_plan, follow_up_required) VALUES(501, 1001, 32.50, 38.6, 'Slight lethargy observed over past 48 hours.', 'Mild dehydration from warm weather changes.', 'Administered subcutaneous fluids. Advise shaded rest.', FALSE),(502, 1006, 0.45, 29.5, 'Minor scale discoloration on lower abdomen.', 'Local bacterial dermatitis from high humidity environment.', 'Apply topical antiseptic cream twice daily for 7 days.', TRUE),(503, 1002, 32.10, 38.4, 'Pre-groom health check baseline lookup.', 'Normal vitals structural index.', 'Clear for general handling and washing cycles.', FALSE),(504, 1003, 41.20, 38.7, 'Pre-therapy functional physical evaluations.', 'Mild joint pain secondary to structural dysplasia.', 'Proceed safely with aquatic exercise routines.', TRUE),(505, 1004, 11.40, 38.8, 'Daycare incoming screening verification check.', 'Healthy baseline condition.', 'Approved for integration into regular playgroups.', FALSE),(506, 1005, 4.20, 39.1, 'Elevated respiratory rate prior to appt cancellation.', 'Mild stress induced hyperthermia elements.', 'Reschedule and evaluate under calm conditions.', FALSE),(507, 1007, 6.80, 38.5, 'Routine pre-styling physical check evaluation.', 'Healthy condition profiles.', 'Approved for full standard grooming services.', FALSE),(508, 1008, 28.30, 38.6, 'High exertion heart rate checks.', 'Excellent athletic conditioning metrics.', 'Cleared for unconstrained advanced agility courses.', FALSE),(509, 1009, 35.40, 38.2, 'Chronic age-related stiffness logs.', 'Osteoarthritis tracking in lower leg regions.', 'Initiate targeted electro-acupuncture sessions.', TRUE),(510, 1010, 4.90, 38.3, 'Pre-boarding structural coat evaluations.', 'Heavy matting behind ears causing minor skin friction.', 'Groom out safely under active session tracking.', FALSE);
-- 7. Populate Beauty_Details (10 Rows)
INSERT INTO Beauty_Details (beauty_id, appointment_id, haircut_style, shampoo_type, nail_trimming, ear_cleaning, grooming_notes) VALUES(601, 1002, 'Standard Breed Trim', 'Hypoallergenic Oatmeal', TRUE, TRUE, 'Handled beautifully. Cooperative during the blow-dry phase.'),(602, 1005, 'Summer Lion Shave', 'De-Shedding Citrus Solution', FALSE, FALSE, 'Appt canceled by owner prior to processing.'),(603, 1001, 'None - Clinical Exam', 'None', FALSE, FALSE, 'Medical focus only; beauty values left default.'),(604, 1003, 'None - Therapy Session', 'Medicated Sulfur', FALSE, TRUE, 'Ears cleaned post hydrotherapy suite to prevent water trap bugs.'),(605, 1004, 'Sanitary Trim Only', 'Hypoallergenic Aloe', TRUE, FALSE, 'Quick touch up work done before daycare check-in.'),(606, 1006, 'None - Reptile Care', 'None', FALSE, FALSE, 'Reptile check; structural beauty tables skipped safely.'),(607, 1007, 'Teddy Bear Teddy Style', 'Moisturizing Coconut Balm', TRUE, TRUE, 'Long dense coat. Requires careful, slow undercoat de-matting pipelines.'),(608, 1008, 'Sport Active Shave', 'Odor Control Eucalyptus', TRUE, FALSE, 'Shortened leg furnishings to reduce trail mud pick up.'),(609, 1009, 'None - Wellness Session', 'None', FALSE, FALSE, 'Holistic focus session. Hair handling unneeded.'),(610, 1010, 'Classic Persian Show Trim', 'Premium Silk Protein Complex', TRUE, TRUE, 'Highly sensitive to facial manipulation. Use soft sponge tools.');
-- 8. Populate Wellness_Details (10 Rows)
INSERT INTO Wellness_Details (wellness_id, appointment_id, therapy_type, session_goals, dietary_recommendations, pet_response_notes) VALUES(701, 1003, 'Hydrotherapy', 'Increase hind-leg mobility and alleviate muscle tightness.', 'Incorporate Omega-3 fatty acid fish oil supplements.', 'Initial resistance entering tank, but swam smoothly for 20 mins.'),(702, 1001, 'General Mobility Check', 'Evaluate clinical baseline agility variables.', 'Maintain calorie restricted diet controls.', 'Exhibited balanced gait across hard floor testing arrays.'),(703, 1002, 'Calming Aromatherapy', 'Reduce sensory panic during coat blowing sequences.', 'Incorporate chamomile calming chews 1hr prior.', 'Showed marked reduction in trembling responses.'),(704, 1004, 'Post-Play Muscle Cool-Down', 'Relax large muscle fields after endurance runs.', 'Ensure clean electrolyte water updates.', 'Enjoyed soft tissue back massages intensely.'),(705, 1005, 'Anxiety Elimination Consultation', 'Address tracking triggers causing sudden booking dropouts.', 'None', 'Session abandoned by client; profile flag updated.'),(706, 1006, 'Environmental Thermal Optimization', 'Establish stable metabolic parameters.', 'Supplement calcium powders over daily cricket feeds.', 'Reactions improved under adjusted basking lamps.'),(707, 1007, 'Desensitization Training', 'Acclimate to high-velocity professional dryer sounds.', 'None', 'Remained stable when paired with high-value treats.'),(708, 1008, 'Cardio Training Integration', 'Optimize respiratory endurance limits.', 'Transition to high-protein performance foods.', 'Maintained target training zones without tracking fatigue markers.'),(709, 1009, 'Laser Acupuncture Alternative', 'Stimulate structural nerve loops dynamically.', 'Add joint green-lipped mussel extracts.', 'Extremely relaxed; fell asleep during therapy steps.'),(710, 1010, 'Stress Isolation Protocols', 'Keep feline cortisol markers minimized while away.', 'Feed small portions of wet food frequently.', 'Responded well to pheromone diffusers in standard cage.');
-- 9. Populate Recreation_Details (10 Rows)
INSERT INTO Recreation_Details (recreation_id, appointment_id, activity_type, socialization_score, energy_level_observed, incident_report) VALUES(801, 1004, 'Group Play', 5, 'High', 'Interacted beautifully with other small breeds. Exceeded expectations.'),(802, 1001, 'Leash Walking Baseline', 4, 'Moderate', 'No structural social conflicts logged during solo route paths.'),(803, 1002, 'Solitary Toy Play Enrichment', 2, 'Low', 'Kept isolated to preserve structural integrity of blow dry styling.'),(804, 1003, 'Low-Impact Shallow Wading Pool', 3, 'Low', 'Focused completely on controlled low exertion movements.'),(805, 1005, 'None - Cancelled Event', NULL, NULL, 'No recreational data generated due to cancellation fields.'),(806, 1006, 'Enclosure Exploration Drills', 1, 'Low', 'Solitary species; zero interaction allowed with other elements.'),(807, 1007, 'Pre-Groom Gentle Pacing Steps', 3, 'Moderate', 'Allowed loose floor time to burn off minor baseline jitters.'),(808, 1008, 'Advanced Agility Obstacle Running', 5, 'Hyperactive', 'Cleared hurdles and tunnel complexes flawlessly without errors.'),(809, 1009, 'Gentle Stretching Grass Walks', 4, 'Low', 'Preferred resting under shaded tree areas over active games.'),(810, 1010, 'Vertical Cat Tree Activity Tracking', 2, 'Low', 'Maintained defensive high-perch positioning. No aggressive acts.');`;
